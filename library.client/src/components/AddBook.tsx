...
const AddBook: React.FC<EditBookProps> = ({ handleGetBooks }) => {
    ...
    const validateBook = (book: BookInput) => {
        const newErrors: any = {};
    ...
    // Manejo del formulario para agregar un libro
    const handleAddBook = async (book: BookInput) => {
        ...
        try {
            ...
            await handleGetBooks(); // Refrescar la lista de libros
            setBook({
                title: '',
                author: '',
                isbn: '',
            ...
            toast.success('Book added successfully!'); // Mostrar mensaje de éxito
        } catch (err) {
            console.error('Failed to add book', err);
            toast.error('Failed to add book. Please try again.'); // Mostrar mensaje de error
        }
    };
